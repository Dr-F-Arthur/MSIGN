...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        data_df = pd.read_csv(os.path.join(data_root, "cb1_ic50.csv")).sample(frac=1., random_state=123)
        ...
        model.load_state_dict(torch.load("./model/pretrain_general_model.pt"))
